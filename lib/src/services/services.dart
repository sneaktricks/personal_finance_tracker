...
class IncomeService {
  ...
  List<IncomeEntry> get entries => 
    storage.containsKey(key) ? [...?storage.get(key)].map((e) => IncomeEntry.fromJson(e)).toList() : [];
...
class ExpenseService {
  ...
  List<ExpenseEntry> get entries => 
    storage.containsKey(key) ? [...?storage.get(key)].map((e) => ExpenseEntry.fromJson(e)).toList() : [];
